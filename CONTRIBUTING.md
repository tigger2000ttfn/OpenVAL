# Contributing to PHAROLON

Thank you for your interest in contributing to PHAROLON. This guide explains how
...
PHAROLON is software used in GMP-regulated environments. Code changes can affect
...
- **Your name is on it.** Every contributor's changes are traceable through Git
  history, which is referenced in the PHAROLON SDL. Regulated sites may audit
  this history during inspections.

### Sign the Contributor License Agreement (CLA)

Before your first pull request is merged, you must sign the PHAROLON CLA. This is
...
createdb pharolon_dev
psql pharolon_dev -f ../schema/pharolon_schema_part1.sql
psql pharolon_dev -f ../schema/pharolon_schema_part2.sql
...
*Thank you for helping build PHAROLON. Every contribution makes GMP compliance more accessible.*
