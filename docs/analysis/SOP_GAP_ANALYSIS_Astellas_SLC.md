# PHAROLON Gap Analysis — Astellas GxP System Life Cycle SOP
...
Astellas enterprise SLC reveals as missing or incomplete in PHAROLON.
...
that do not yet exist in PHAROLON. This document maps every gap with the
required fix.
...
Key differences from PHAROLON's generic risk assessment:
...
PHAROLON has traditional numbered requirements but not this Agile format.
...
Astellas has TWO distinct lifecycle paths. PHAROLON only has Path A.
...
This matrix is the backbone of risk-based testing. PHAROLON has risk scoring
...
The Astellas Reviewer/Approver Matrix reveals roles missing from PHAROLON:

| Astellas Role | PHAROLON Equivalent | Gap |
|---|---|---|
...
in PHAROLON. It is common in large enterprise pharma programs.
...
| Astellas Template | PHAROLON Status After Fix |
|---|---|
...
*PHAROLON Gap Analysis | Based on Astellas GxP SLC SOP*
*Generated by Head of Global QA, PHAROLON Project | 2026-04-08*
