# PHARION Gap Analysis — Astellas GxP System Life Cycle SOP
...
Astellas enterprise SLC reveals as missing or incomplete in PHARION.
...
that do not yet exist in PHARION. This document maps every gap with the
required fix.
...
Key differences from PHARION's generic risk assessment:
...
PHARION has traditional numbered requirements but not this Agile format.
...
Astellas has TWO distinct lifecycle paths. PHARION only has Path A.
...
This matrix is the backbone of risk-based testing. PHARION has risk scoring
...
The Astellas Reviewer/Approver Matrix reveals roles missing from PHARION:

| Astellas Role | PHARION Equivalent | Gap |
|---|---|---|
...
in PHARION. It is common in large enterprise pharma programs.
...
| Astellas Template | PHARION Status After Fix |
|---|---|
...
*PHARION Gap Analysis | Based on Astellas GxP SLC SOP*
*Generated by Head of Global QA, PHARION Project | 2026-04-08*
